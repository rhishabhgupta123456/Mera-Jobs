...
class CompanyAdapter(private var dataList: ArrayList<CompanyList> , private var  requireActivity: Activity) :
    RecyclerView.Adapter<CompanyAdapter.ViewHolder>() {
    class ViewHolder(private val binding: ItemCompanyBinding) :
