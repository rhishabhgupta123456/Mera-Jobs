...
import tech.merajobs.databinding.ItemIndustryBinding
import tech.merajobs.utility.AppConstant


class IndustryAdapter(private var dataList: ArrayList<IndustryList>, private var  requireActivity: Activity) :
    RecyclerView.Adapter<IndustryAdapter.ViewHolder>() {
    class ViewHolder(private val binding: ItemIndustryBinding) :
    ...
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): ViewHolder {
        val binding =
            ItemIndustryBinding.inflate(LayoutInflater.from(parent.context), parent, false)
