...
import tech.merajobs.databinding.ItemCategoryBinding
import tech.merajobs.utility.AppConstant


class CategoryAdapter(private var dataList: ArrayList<CategoryList> , private var requireActivity : Activity) :
